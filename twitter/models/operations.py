...
from .models import *
from twitter.tasks import get_users_followers, get_users_friends
...
class OperationConstructNetwork(Operation):
    ...
    def set_target(self, twitter_users, campaign_slug, metric=None):
